...
export declare function buildOurSimpleTransaction({ connection, makeTxVersion, payer, innerTransactions, recentBlockhash, addLookupTableInfo, }: {
    makeTxVersion: TxVersion;
    payer: PublicKey;
    connection: Connection;
    innerTransactions: InnerSimpleTransaction[];
    recentBlockhash?: string | undefined;
    addLookupTableInfo?: CacheLTA | undefined;
},inputToken:PublicKey,inputTokenAmount:number): Promise<(VersionedTransaction | Transaction)[]>;
