...
exports.BNDivCeil = exports.fetchMultipleMintInfos = exports.minExpirationTime = exports.getTransferAmountFee = exports.buildOurSimpleTransaction = exports.buildSimpleTransaction = exports.unwarpSol = exports.getWSOLAmount = void 0;
...
function unwarpSol(_a) {
    return __awaiter(this, arguments, void 0, function* ({ ownerInfo, tokenAccounts, makeTxVersion, connection, }) {
        const WSOL_MINT = new web3_js_1.PublicKey(token_1.WSOL.mint);
...
function buildSimpleTransaction(_a) {
    return __awaiter(this, arguments, void 0, function* ({ connection, makeTxVersion, payer, innerTransactions, recentBlockhash, addLookupTableInfo, }) {
        var _b;
        ...
        for (const itemIx of innerTransactions) {
            txList.push(_makeTransaction({
                ...
                lookupTableInfos: Object.values(Object.assign(Object.assign({}, (addLookupTableInfo !== null && addLookupTableInfo !== void 0 ? addLookupTableInfo : {})), ((_b = itemIx.lookupTableAddress) !== null && _b !== void 0 ? _b : {}))),
            }));
        }
        return txList;
    });
...
function buildOurSimpleTransaction(_a, inputToken_1, inputTokenAmount_1) {
    return __awaiter(this, arguments, void 0, function* ({ connection, makeTxVersion, payer, innerTransactions, recentBlockhash, addLookupTableInfo, }, inputToken, inputTokenAmount) {
        var _b;
        if (makeTxVersion !== type_1.TxVersion.V0 && makeTxVersion !== type_1.TxVersion.LEGACY)
            throw Error(' make tx version args error');
        let blockhash = (yield connection.getLatestBlockhash());
        const _recentBlockhash = blockhash.blockhash;
        const txList = [];
        //for (const itemIx of innerTransactions) {
        let instructions = [];
        if (inputToken.toBase58() == 'So11111111111111111111111111111111111111112') {
            instructions.push((0, spl_token_1.createAssociatedTokenAccountIdempotentInstruction)(payer, (0, spl_token_1.getAssociatedTokenAddressSync)(new web3_js_1.PublicKey("So11111111111111111111111111111111111111112"), payer), payer, inputToken, new web3_js_1.PublicKey('TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA')));
            instructions.push(web3_js_1.SystemProgram.transfer({
                fromPubkey: payer,
                toPubkey: (0, spl_token_1.getAssociatedTokenAddressSync)(new web3_js_1.PublicKey("So11111111111111111111111111111111111111112"), payer),
                lamports: inputTokenAmount //max - (3 * rent) 
            }));
        }
        instructions = [...instructions, ...innerTransactions[0].instructions];
        txList.push(_makeTransaction({
            makeTxVersion,
            instructions: instructions,
            payer,
            recentBlockhash: _recentBlockhash,
            signers: innerTransactions[0].signers,
            lookupTableInfos: Object.values(Object.assign(Object.assign({}, (addLookupTableInfo !== null && addLookupTableInfo !== void 0 ? addLookupTableInfo : {})), ((_b = innerTransactions[0].lookupTableAddress) !== null && _b !== void 0 ? _b : {}))),
        }));
        // }
        return { txList: txList[0], blockhash: _recentBlockhash, lastValidBlockHeight: blockhash.lastValidBlockHeight };
    });
}
exports.buildOurSimpleTransaction = buildOurSimpleTransaction;
/*
...
function fetchMultipleMintInfos(_a) {
    return __awaiter(this, arguments, void 0, function* ({ connection, mints }) {
        var _b, _c;
        if (mints.length === 0)
            return {};
        ...
        for (const i of mintInfos) {
            const t = (0, spl_token_1.unpackMint)(i.pubkey, i.accountInfo, (_b = i.accountInfo) === null || _b === void 0 ? void 0 : _b.owner);
            mintK[i.pubkey.toString()] = Object.assign(Object.assign({}, t), { feeConfig: (_c = (0, spl_token_1.getTransferFeeConfig)(t)) !== null && _c !== void 0 ? _c : undefined });
        }
        return mintK;
    });
}
